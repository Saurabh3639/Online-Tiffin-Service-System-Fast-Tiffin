...
<head>
  ...
  <title>Fast-Tiffin.com | Order Page</title>
		...
		<div class="contact_top">
	 		<div class="container">
	 			<div class="col-md-6 contact_left wow fadeInRight" data-wow-delay="0.4s">
					...
					<p>Pay online via Credit or Debit Card!!!!!!.</p>
	 				<?php
            $invid=$_GET['invid'];
          ...
          ?>
            ...
            <table border="1" class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
              <tr>
                <th colspan="5" style="text-align: center;color: red;font-size: 20px">Payment Detail</th>
              </tr>
              <tr>
            ...
            <p style="text-align: center;font-size: 20px">
              <a href="pay.php?invid=<?php echo $row->OrderNumber;?>" class="btn btn-primary"><strong style="color: red">Payment</strong> </a></h3>
									&nbsp;
            </p>
				</div>
			</div>
