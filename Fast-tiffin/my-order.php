...
<head>
	...
	<title>Fast-Tiffin.com  | My Tiffin Order</title>
...
<body>
	...
	<div class="cart-items">
		<div class="container">
			 ...
			 <h1>My Order</h1>
			 <p>* you can only cancel your order before it is getting confirmed!</p>
						...
						<div class="cart-item cyc">
					   	...
					   	<div class="cart-item-info">
							...
							<div class="delivery">
							 	...
							 	<h3><a href="invoice.php?invid=<?php echo $row->OrderNumber;?>" class="btn btn-primary"><strong style="color: green">Invoice</strong> </a></h3>
									&nbsp;
									<h3><a href="payment.php?invid=<?php echo $row->OrderNumber;?>" class="btn btn-primary"><strong style="color: green">payment</strong> </a></h3>
									&nbsp;
									<h3><a href="javascript:confirmCancel('cancel .page?id=1')" class="btn btn-primary"><strong style="color: red">Cancel order</strong> </a></h3>
								<?php } ?>
								<p>Status : &nbsp;<?php if($row->Status==""){ ?> <?php echo "Not Updated Yet"; ?></p>
								<?php } else { ?>

								<p> <?php  echo htmlentities($row->Status);?></p><?php } ?> 
