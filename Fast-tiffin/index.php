...
<head>
	...
	<title>Fast-Tiffin.com | Home Page</title>
		    ...
		    <div class="container">
				<div class="banner-info">
					<div class="banner-info-head text-center wow fadeInLeft" data-wow-delay="0.5s">
						<h1>Welcome to Fast Tiffin.com</h1>
						<div class="line">
		...
		<div class="ordering-section" id="Order">
			<div class="container">
				<div class="ordering-section-head text-center wow bounceInRight" data-wow-delay="0.4s">
					<h3>Yummy food which will please you time, money and tummy.</h3>
					<div class="dotted-line">
						<h4>Best Service to fulfil your expectations </h4>
					</div>
				</div>
