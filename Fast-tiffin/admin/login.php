...
<head>
    ...
    <title>Fast-Tiffin.com - Login Page</title>
    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="auth-box row">
                <div class="col-lg-7 col-md-5 modal-bg-img" style="background-image: url(assets/images/big/login-img.png); width: 300;height: 400">
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 text-center mt-5">
                                   <!-- <input type="checkbox" id="remember" name="remember" <?php if(isset($_COOKIE["user_login"])) { ?> checked <?php } ?> />
                                    ...
                                    <p><a href="register-admin.php">Create an Account</a></p>
